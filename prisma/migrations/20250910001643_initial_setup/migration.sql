/*
  ...
  - You are about to drop the column `breakMinutes` on the `shifts` table. All the data in the column will be lost.
  - You are about to drop the column `casualPay` on the `shifts` table. All the data in the column will be lost.
